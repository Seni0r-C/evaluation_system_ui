    ...
    return (
        <div className="p-8 bg-gray-100 min-h-screen">
            <div className="bg-white shadow-md rounded-md p-6">
                ...
                <p className="text-gray-600 text-center mb-6">Modalidad: *Nombre de la modalidad*</p>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Sección del documento */}
                    <div className="lg:col-span-2">
                        <h2 className="text-xl font-semibold mb-4">Documento de Titulación</h2>
                        <div className="border-2 border-gray-300 rounded-md h-96 overflow-auto bg-gray-50 flex items-center justify-center">
                            <p className="text-gray-500">[Vista previa del documento aquí]</p>
                        </div>
                    </div>
