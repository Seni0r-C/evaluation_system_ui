...
const Layout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#015198] text-gray-800">
            {/* Barra superior */}
            <header className="bg-gray-100 text-gray-800 p-2 flex justify-between items-center shadow-lg z-50">
            ...
            <div
                className={`flex flex-grow overflow-hidden transition-all duration-300 ease-in-out`}
            >
                {/* Barra lateral */}
                <aside
